...
ifeq ($(shell arch),aarch64)
	cd ../tools/packaging/kernel; \
	echo "" >> configs/fragments/arm64/acpi.conf; \
	echo "CONFIG_MEMCG_SWAP_ENABLED=y" >> configs/fragments/arm64/acpi.conf; \
	echo "CONFIG_NF_LOG_COMMON=y" >> configs/fragments/arm64/acpi.conf; \
	echo "CONFIG_NF_NAT_NEEDED=y" >> configs/fragments/arm64/acpi.conf; \
	echo "CONFIG_NF_NAT_PROTO_DCCP=y" >> configs/fragments/arm64/acpi.conf; \
	echo "CONFIG_NF_NAT_PROTO_UDPLITE=y" >> configs/fragments/arm64/acpi.conf; \
	echo "CONFIG_NF_NAT_PROTO_SCTP=y" >> configs/fragments/arm64/acpi.conf; \
	echo "CONFIG_NF_NAT_PROTO_GRE=y" >> configs/fragments/arm64/acpi.conf; \
	echo "CONFIG_NF_NAT_IPV4=y" >> configs/fragments/arm64/acpi.conf; \
	echo "" >> configs/fragments/arm64/acpi.conf; \
